...
namespace Zeta.Inpark.Food.Tests;
...
public class Testing
{
    ...
    public static FoodDbContext DbContext => Scope.ServiceProvider.GetRequiredService<FoodDbContext>();
    ...
    public void RunBeforeAnyTests()
    {
        ...
        services.AddLogging();
        services.AddFood(_configuration);
    ...
    {
        var connectionString = _configuration.GetConnectionString("FoodDatabase");

        _respawner ??= await Respawner.CreateAsync(connectionString, new()
        {
