...
public class AalborgZooContentMapperTest : TestBase
{
  ...
  [Test]
    public void ParseContent_ShouldReturnExpectedOutput_WhenGivenInput()
    {
        ...
        var logger = new Mock<ILogger<AalborgZooAnimalContentMapper>>();
        
        var parseContent = new AalborgZooAnimalContentMapper(htmlTransformer, logger.Object);
        var content =
        ...
        var expectedContent = new List<IContent>
        {
          new Content(new object(),
            ...
            {
              Spacer(),
              Text("Strudsen er den største nulevende fugl, den lægger det største æg af alle nulevende væsener, og den er det hurtigste tobenede dyr, der findes. En struds som flygter fra et rovdyr kan nå op på 70 kilometer i timen."),
              Spacer(),
              Spacer(),
              Text("Der findes i dag fem strudsearter: Nanduen i Sydamerika, emuen i Australien, kiwien i New Zealand, strudsen i Afrika samt kasuaren i Ny Guinea."),
              Spacer(),
              Spacer(),
              Text("Det er ikke rigtigt at strudsen gemmer sit hoved i sandet. Denne misforståelse kan være opstået, da det på lang afstand kan være svært at se hovedet på en græssende struds."),
              Spacer(),
              Spacer(),
              Text("Strudse holder oftest sammen i grupper bestående af én han og op til 15 hunner. Blandt disse hunner har hannen sin førstedame, som på territoriet vælger en fordybning, som hannen på forhånd har lavet. Her lægger hun sine æg, hvorefter de andre hunner i gruppen kommer til. Udrugning klares af hannen og hans foretrukne hun. Arbejdet fordeles således at hannen ruger om natten og hunnen ruger om dagen. Et strudseæg vejer omkring 1500 gram, som svarer til cirka 20 hønseæg."),
              Spacer(),
              Spacer(),
          ...
          new Content(
            ...
            new List<Content>()
            {
              ...
              {
                Spacer(),
                ListItem("Udbredelse: På åbne savanneområder i Øst- og Sydafrika. Der findes også vilde strudse i Australien, som nedstammer fra strudse, der har været holdt i fangenskab"),
                Spacer(),
                ListItem("Bestand: Strudsen var tidligere almindelig i store dele af Afrika. Den er i dag gået stærkt tilbage i antal, primært fordi den har været efterstræbt af mennesker. Strudsen er i dag truet."),
                Spacer(),
                ...
                Spacer(),
                ListItem("Antal æg: 8-10 æg pr. hun. I en strudserede kan der være helt op til 60 æg lagt af forskellige hunner. Hvert æg vejer cirka 1500 gram"),
                Spacer(),
