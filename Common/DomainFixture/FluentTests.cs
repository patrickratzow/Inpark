...
public static class FluentTests
{
    ...
    private static void ScanEntityConfigurations(Type entityType)
    {
        ...
        foreach (var configuration in configurations)
        {
            ...
            //.First(t => Bases.Any(b => t.IsAssignableTo(b) || IsAssignableToGenericType(t, b)));
    ...
    private static void ApplyPropertyConventions(IClassConfiguration config,
        ...
        Type entityType)
    {
        ...
        var properties =
            entityType.GetProperties(BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic);
        foreach (var property in properties)
        {
            var applyPropertyConvention = new ApplyPropertyConvention(config, entityBuilder, entityType,
                _conventions!,
                property);
    ...
    private static List<dynamic>? GetValidExpressions(IPropertyBuilder propertyBuilder)
    {
        ...
        return validExpressionsProperty is not ICollection validExpressions
            ? null
            : GetExpressions(validExpressions);
    }
    ...
    private static List<dynamic>? GetInvalidExpressions(IPropertyBuilder propertyBuilder)
    {
        ...
        return invalidExpressionsProperty is not ICollection invalidExpressions
            ? null
            : GetExpressions(invalidExpressions);
    }
