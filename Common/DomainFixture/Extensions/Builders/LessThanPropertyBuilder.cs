    ...
    where TProperty : IComparable, IComparable<TProperty>
{
    ...
    public ILessThanScenarioBuilder<TProperty, TEntity> LessThanOrEqualTo(
    ...
    where TProperty : IComparable, IComparable<TProperty>
{
    ...
    public LessThanPropertyBuilder(Expression<Func<TEntity, TProperty>> propertyExpression) : base(
        propertyExpression)
    {
    }
