    ...
    where TEntity : class
{
    ...
    public IComparablePropertyBuilder<ushort, TEntity> Property(
        Expression<Func<TEntity, ushort>> propertyExpression)
        => ComparablePropertyBuilder(propertyExpression);
    ...
    public IComparablePropertyBuilder<double, TEntity> Property(
        Expression<Func<TEntity, double>> propertyExpression)
        => ComparablePropertyBuilder(propertyExpression);

    public IComparablePropertyBuilder<decimal, TEntity> Property(
    ...
    private IComparablePropertyBuilder<TProperty, TEntity> ComparablePropertyBuilder<TProperty>(
        ...
        where TProperty : struct, IComparable, IComparable<TProperty>, IConvertible, IEquatable<TProperty>,
        IFormattable
    {
    ...
    IFormattable
{
    ...
    public ComparablePropertyBuilder(Expression<Func<TEntity, TProperty>> propertyExpression) : base(
        propertyExpression)
    {
    ...
    internal new List<Expression<Func<TEntity, TProperty>>> ValidExpressions
        => _lessThanBuilder.ValidExpressions
            .Concat(_equalsBuilder.ValidExpressions)
            .Concat(_greaterThanBuilder.ValidExpressions)
            .Concat(base.ValidExpressions)
            .ToList();

    internal new List<Expression<Func<TEntity, TProperty>>> InvalidExpressions
        => _lessThanBuilder.InvalidExpressions
            .Concat(_equalsBuilder.InvalidExpressions)
            .Concat(_greaterThanBuilder.InvalidExpressions)
            .Concat(base.InvalidExpressions)
            .ToList();

    public override bool IsEmpty =>
        _lessThanBuilder.IsEmpty && _equalsBuilder.IsEmpty && _greaterThanBuilder.IsEmpty;
    ...
    IFormattable
{
    ...
    protected override void ApplyScenario(ScenarioApplier<TProperty, TEntity> applier, bool valid) { }
}
