    ...
    where TProperty : struct, IComparable, IComparable<TProperty>
{
    ...
    public GreaterThanPropertyBuilder(Expression<Func<TEntity, TProperty>> propertyExpression) : base(
        propertyExpression)
    {
    }
    ...
    public IGreaterThanScenarioBuilder<TProperty, TEntity> GreaterThanOrEqualTo(
