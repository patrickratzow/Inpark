...
public interface IClassConfiguration<TEntity> : IClassConfiguration
    where TEntity : class
{
...
public interface IClassConventionsConfiguration
{
    ...
    IClassConventionsConfiguration Add<TConvention>()
        where TConvention : IPropertyConvention;

    IClassConventionsConfiguration Add(Type type);

    IClassConventionsConfiguration Remove<TConvention>()
        where TConvention : IPropertyConvention;
...
public class ClassConventionsConfiguration : IClassConventionsConfiguration
{
    ...
    public IClassConventionsConfiguration Add<TConvention>()
        where TConvention : IPropertyConvention
    {
    ...
    public IClassConventionsConfiguration Remove<TConvention>()
        where TConvention : IPropertyConvention
    {
        var instance = Activator.CreateInstance<TConvention>();
...
public abstract partial class FixtureConfiguration<TEntity> : IClassConfiguration<TEntity>
    where TEntity : class
{
    public IEntityConfigurationBuilder<TEntity> ConfigurationBuilder { get; }
